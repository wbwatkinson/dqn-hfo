...
# folders+="${exp4}_000 ${exp4}_001 ${exp4}_002 ${exp4}_003 ${exp4}_004 ${exp4}_005 ${exp4}_006 ${exp4}_007 "
# exp4="baseline/baseline_empty_resequenced_wo_status/baseline_empty_resequenced_wo_status"
# folders+="${exp4}_002 "
# exp4="baseline/baseline_empty_resequenced_wo_status_padded_zeros/baseline_empty_resequenced_wo_status_padded_zeros"
# folders+="${exp4}_001 ${exp4}_003 ${exp4}_006 "
# exp4="baseline/baseline_empty_resequenced_wo_status_padded_random/baseline_empty_resequenced_wo_status_padded_random"
# folders+="${exp4}_000 "

# exp4="test/test_frozen_layers/test_frozen_layers"
# folders+="${exp4}_000 ${exp4}_001 ${exp4}_002 ${exp4}_003 ${exp4}_004 ${exp4}_005 ${exp4}_006 ${exp4}_007 "
...
# folders+="baseline/baseline_test_frozen/baseline_test_frozen_000 "
...
do
	...
	# f+="/dqn.INFO"
	header="==> ${f} <=="
	detail=$(tail -n 500 $f 2>/dev/null | grep 'Episode' | tail -1)
	echo $header $detail
